...
def test_claims_supported_token_overlap_does_not_hard_support_claim() -> None:
    ledger = EvidenceLedger()
    ledger.add_external_evidence(
        locator="fixture",
        claims_supported=["The theorem is proven complete for the benchmark result."],
    )

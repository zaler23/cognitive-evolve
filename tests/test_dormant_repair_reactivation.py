...
def _repairable_candidate(candidate_id: str = "archive-repair") -> CandidateGenome:
    candidate = CandidateGenome(
        ...
        artifact={
            "path": "cognitive_evolve_runtime/nexus/loop/__init__.py",
            "unified_diff": (
                "diff --git a/cognitive_evolve_runtime/nexus/loop/__init__.py b/cognitive_evolve_runtime/nexus/loop/__init__.py\n"
                "--- a/cognitive_evolve_runtime/nexus/loop/__init__.py\n"
                "+++ b/cognitive_evolve_runtime/nexus/loop/__init__.py\n"
                "@@ -1 +1 @@\n"
                "-old\n"
            ),
        },
...
def test_recoverable_dormant_archive_seed_prevents_no_parents_available() -> None:
    ...
    assert child.metadata["repair_seed"]["target_files"] == ["cognitive_evolve_runtime/nexus/loop/__init__.py"]
...
def test_repair_seed_prompt_view_exposes_concise_contract() -> None:
    ...
    assert view["repair_seed_contract"]["target_files"] == ["cognitive_evolve_runtime/nexus/loop/__init__.py"]

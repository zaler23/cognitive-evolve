...
def test_failure_archive_reseed_rejects_documentation_only_records() -> None:
    archives = ArchiveManager()
    archives.failure_archive.records["Cnote"] = {
        "candidate_id": "Cnote",
        "failure_signature": "runtime_code_change_absent:documentation_only_patch; source_binding_missing_path; search_seed_not_final",

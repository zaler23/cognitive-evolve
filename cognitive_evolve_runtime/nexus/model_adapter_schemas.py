...
def _evolution_policy_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            ...
            "search_space": {
                "type": "object",
                "description": "Active model-authored search-space plan for this policy. Define objective-level candidate families or exploration planes, their distinct mechanisms, and any soft coverage quotas.",
                "additionalProperties": True,
            },
        },
        "additionalProperties": True,
    ...
    return {
        ...
        "properties": {
            "plans": {
                ...
                "items": {
                    "type": "object",
                    "required": ["operator", "parent_ids", "instruction"],
                    "properties": {
                        "operator": {"type": "string"},
                        "parent_ids": {"type": "array", "minItems": 1, "items": {"type": "string", "minLength": 1}},
    ...
    return {
        ...
        "properties": {
            ...
            "edge_knowledge_seeds": {
                "type": "array",
                "description": "Concrete edge knowledge, boundary results, uncommon mechanisms, or specialist heuristics used by this candidate. In a seed portfolio these must be non-empty and non-redundant for edge_knowledge slots.",
                "items": {"type": "string"},
            },
            ...
            "niche_memberships": {
                "type": "array",
                "description": "Model-chosen angles, perspectives, representations, or disciplines. The runtime does not provide a fixed discipline ontology.",
                "items": {"type": "string"},
            },
            "search_space": {
                "type": "object",
                "description": "Model-authored search-space placement for this candidate. Include family_id or plane_id from the active search_space_contract. With policy.seed_portfolio include exact seed_axis. Axis receipts: direct_mainstream adds seed_axis_claim; cross_domain_transfer adds transfer_source_domain; counterexample_probe adds probe_target_assumption; representation_shift adds representation_shift.from/to; tool_probe adds tool_probe_plan. edge_knowledge uses top-level edge_knowledge_seeds.",
                "additionalProperties": True,
            },
            ...
            "evaluation_dimensions": {
                "type": "array",
                "description": "Non-empty model-authored observable dimensions for judging this candidate's concrete artifact delta and later grounded outcome.",
                "items": {"type": "string"},
            },
            "final_gate": {
                "type": "object",
                ...
                "properties": {
                    "transfer_receipt": {
                        ...
                        "properties": {
                            ...
                            "preserved_invariant": {"type": "string"},
                            "predicted_break_condition": {"type": "string"},
                    ...
                    "blend_receipt": {
                        ...
                        "properties": {
                            ...
                            "retained_from_primary": _string_array(),
                            "borrowed_from_donor": {
                                "type": "array",
                                "minItems": 1,
                                "items": {"type": "string"},
                            },
                            "structural_correspondence": _string_array(),
                            "emergent_delta": _string_array(),
                            "incompatibilities": _string_array(),
                            "unresolved_obligations": _string_array(),
                            "artifact_hash": {"type": "string"},
                        },
                    },
                },
...
def _stop_decision_schema() -> dict[str, Any]:
    return {
        ...
        "properties": {
            "stop": {"type": "boolean"},
            "reason": {"type": "string"},
            "solved": {"type": "boolean", "const": False},

...
def build_replay_record(
    ...
    *,
    ...
    replay_verified = bool(
        raw_result.replayable
        and kind in _REPLAYABLE_ORACLES
        and raw_result.metadata.get("diagnostics_only") is not True
        and (raw_result.metadata.get("replay_verified") is True or raw_result.metadata.get("engine_replay_verified") is True)
    )
    return {

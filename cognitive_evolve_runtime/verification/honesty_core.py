...
class MeasuredVerificationResult:
    ...
    def to_verification_result(self) -> VerificationResult:
        ...
        raw_diagnostics_only = bool(metadata.get("diagnostics_only"))
        raw_legacy = bool(metadata.get("legacy"))
        metadata.update(
            {
                ...
                "diagnostics_only": raw_diagnostics_only,
                "legacy": raw_legacy,
                "raw_diagnostics_only": raw_diagnostics_only,
...
def measure_verification_result(
    ...
    if raw_result.metadata.get("diagnostics_only") or raw_result.metadata.get("legacy") or upper_bound == VerificationStrength.NONE:
        upper_bound = VerificationStrength.from_value(raw_result.metadata.get("certification_upper_bound"))

...
class DecomposedVerifier:
    ...
    def check(self, candidate: Any) -> VerificationResult:
        ...
        if not self.required_claims:
            return VerificationResult(False, score=0.0, replayable=False, diagnostics=["no_required_claims"], metadata={"fingerprint": self.fingerprint, "oracle_kind": "decomposed", "diagnostics_only": True, "validation_status": "not_run"})

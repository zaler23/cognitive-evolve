...
class EmpiricalVerifier:
    ...
    def check(self, candidate: Any) -> VerificationResult:
        ...
        return VerificationResult(passed, score=empirical_score, evidence_ref="evidence-" + stable_hash({"score": empirical_score, "threshold": self.threshold})[:16], replayable=True, diagnostics=["empirical_score_checked"], metadata={"fingerprint": self.fingerprint, "oracle_kind": "empirical", "diagnostics_only": False, "replay_verified": True})

...
class EmpiricalVerifier:
    ...
    def check(self, candidate: Any) -> VerificationResult:
        ...
        return VerificationResult(passed, score=empirical_score, strength=self.strength, evidence_ref="evidence-" + stable_hash({"score": empirical_score, "threshold": self.threshold})[:16], replayable=True, diagnostics=["empirical_score_checked"], metadata={"fingerprint": self.fingerprint})

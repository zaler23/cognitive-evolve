    ...
    for diagnostic in diagnostics:
        ...
        out.append(
            FailureMicroGuidance(
                ...
                source_bindings=list(source_bindings or []),
...
def _repeat_pattern_for_blocker(blocker: str) -> str:
    ...
    if blocker in {"runtime_code_change_required", "runtime_code_change_absent:documentation_only_patch"}:
        return "do_not_repeat_documentation_only_changes_for_runtime_objectives"

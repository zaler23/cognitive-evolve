...
from cognitive_evolve_runtime.core.serialization import coerce_str_list, stable_hash, utc_now
...
class TextInputPacket:
    ...
    def from_text(cls, text: str) -> "TextInputPacket":
        ...
        claims = [seg for seg in segments if seg not in constraints]

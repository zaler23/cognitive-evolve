...
class ProjectCandidateGenome(CandidateGenome):
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ProjectCandidateGenome":
        ...
        verification_result = (
            coerce_dict(data.get("preliminary_result"))
            or coerce_dict(data.get("verification_result"))
            or coerce_dict(base_data.get("verification_result"))
        )
        base_data.pop("preliminary_result", None)

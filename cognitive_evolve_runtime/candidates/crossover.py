...
def crossover(parent_a: CandidateGenome, parent_b: CandidateGenome, *, instruction: str = "combine complementary genes") -> CandidateGenome:
    ...
    return CandidateGenome(
        ...
        verification_result={},
        metadata={"crossover_instruction": instruction, "parent_verification_summary": _parent_verification_summary(parent_a, parent_b)},
    )
...
def _parent_verification_summary(*parents: CandidateGenome) -> dict[str, Any]:

...
def uses_artifact_policy(policy: ArtifactPolicy) -> bool:
    return bool(
        policy.machine_readable_required
        or policy.artifact_type
...
__all__ = ["artifact_policy_from_config", "normalize_artifact", "semantic_drift_diagnostics", "uses_artifact_policy"]

...
The model decides task semantics: objective contracts, policy axes, niches, concrete offspring variation, relative ratings, stagnation diagnosis, and synthesis rules.

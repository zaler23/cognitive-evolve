...
This project is a standalone CognitiveEvolve source and runtime package with explicit provider and tool adapter boundaries.
...
`--scope core` checks source health. `--scope runtime` checks standalone runtime entrypoints and dependencies.
